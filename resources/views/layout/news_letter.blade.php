                ...
                <div class="newsletter">
                    ...
                    <form method="post" action="/contact#contact_form" id="contact_form" accept-charset="UTF-8" class="contact-form">
                        ...
                        <div class="input-row">
                            ...
                            <div class="d-flex">
                                <input type="email" class="contact_email form-control form-control-sm" name="contact[email]" required="" placeholder="Enter your email address..." aria-label="enter your email address..." data-uw-rm-form="fx">
                                <input type="submit" class="global-button global-button--primary newsletter-form__sign-up btn btn-secondary btn-sm ms-2" value="Sign Up" data-uw-rm-form="submit">
                            </div>
                        </div>
                    </form>
                </div>
