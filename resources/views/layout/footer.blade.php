...
<footer class="footer">
    ...
    <section class="bg-light border-top py-4 py-md-5 py-xl-8">
        <div class="container overflow-hidden">
            <div class="row gy-4 gy-lg-0 justify-content-xl-betweenx">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="widget">
                        ...
                        <p>
                        <div class="btn btn-primary" data-href="http://127.0.0.1:8000/trang-chu" data-layout=""
                            data-size=""><a target="_blank"
                                href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2F127.0.0.1%3A8000%2Ftrang-chu&amp;src=sdkpreparse"
                                class="fb-xfbml-parse-ignore text-white" style="text-decoration: none"><i
                                    class="fa-brands fa-facebook"></i> Chia sẻ</a></div>
                        </p>
                        <p>
                        <div class="fb-page" data-href="https://www.facebook.com/axeandsledge" data-tabs=""
                            data-width="" data-height="" data-small-header="false" data-adapt-container-width="false"
                            data-hide-cover="false" data-show-facepile="false">
                            <blockquote cite="https://www.facebook.com/axeandsledge" class="fb-xfbml-parse-ignore"><a
                                    href="https://www.facebook.com/axeandsledge">Axe &amp; Sledge Supplements</a>
                            </blockquote>
                        </div>
                        </p>
                    </div>
            ...
            <div class="row gy-4 gy-md-0">
                <div class="col-xs-12 col-sm-6 col-md-4 order-0 order-md-0">
                    <div class="footer-logo-wrapper text-center text-sm-start">
                        <a href="#!">
                            <img src="https://axeandsledge.com/cdn/shop/files/axe-logo_410x.png?v=1614293969"
                                alt="" width="175" height="100">
                        </a>
                    </div>
                </div>
