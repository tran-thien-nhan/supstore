...
@section('header')
    ...
    <!-- Các thẻ Meta OG -->
    <meta property="og:title" content="{{ $meta_category_title }}" />
    <meta property="og:description" content="{{ $meta_desc }}" />
    <meta property="og:url" content="{{ URL::current() }}" />
    <meta property="og:type" content="website" />
    <!-- End Các thẻ Meta OG -->
    <title>{{$meta_category_title}}</title>
@endsection
            ...
            @foreach ($category_by_id as $key => $cate_id)
                <div class="container col mb-4">
                    <div class="card border-0">
                        <a href="{{URL::to('/chi-tiet-san-pham/'.$cate_id->product_id)}}" class="d-flex justify-content-center align-items-center">
